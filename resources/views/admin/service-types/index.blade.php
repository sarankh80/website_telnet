...
<div class="flex items-center justify-between mb-6">
    <p class="text-sm text-slate-400">{{ $serviceTypes->total() }} types total</p>
    ...
    <table class="w-full text-sm min-w-[560px]">
        <thead>
            <tr class="border-b border-slate-800 text-xs text-slate-400 uppercase tracking-wider">
                ...
                <th class="px-5 py-3.5 text-left hidden md:table-cell">Category (Slug)</th>
        ...
        <tbody class="divide-y divide-slate-800">
            ...
            @empty
                <tr><td colspan="5" class="px-5 py-10 text-center text-slate-500">No service types yet.</td></tr>
            @endforelse
        </tbody>
    </table>
    </div>
