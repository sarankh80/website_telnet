...
@section('title', $serviceType->exists ? __('admin.btn.edit') : __('admin.service_types.add'))
...
<div class="max-w-7xl">
    ...
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6">
        <form method="POST"
            ...
            <div>
                <label class="block text-xs font-medium text-slate-400 mb-1.5">{{ __('admin.service_types.slug_cat') }}</label>
