...
return [
    ...
    'datatable' => [
        'search'        => 'ស្វែងរក…',
        'per_page'      => '{select}',
        'no_rows'       => 'រកមិនឃើញទិន្នន័យ',
        'no_results'    => 'រកមិនឃើញទិន្នន័យដែលត្រូវគ្នា',
        'info'          => 'បង្ហាញ {start} ដល់ {end} ក្នុង {rows} ធាតុ',
        'info_filtered' => 'បង្ហាញ {start} ដល់ {end} ក្នុង {rows} ធាតុ (ត្រូវបានច្រោះ)',
    ],
];
